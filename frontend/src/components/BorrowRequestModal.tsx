    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {/* Error Message */}
          {error && (
            <div className="bg-danger-50 border-2 border-danger-300 text-danger-800 px-4 py-3 rounded-lg flex items-start gap-3 animate-slide-up">
              <svg
              ...
              <div className="flex-1">
                <p className="font-semibold text-sm">Request Conflict</p>
