  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 via-blue-600 to-purple-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="mb-8">
            ...
            <p className="text-lg text-blue-100 leading-relaxed max-w-md">
              Connect with fellow outdoor enthusiasts and build a trusted
              network for sharing camping and hiking gear.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-blue-100">Access Premium Outdoor Gear</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-blue-100">Sustainable Gear Sharing</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                <span className="text-sm">⭐</span>
              </div>
              <span className="text-blue-100">Trusted Community Reviews</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-24 right-24 w-24 h-24 bg-white/5 rounded-full"></div>
        <div className="absolute top-1/3 right-8 w-20 h-20 bg-white/10 rounded-full"></div>
      </div>

      {/* Right side - Sign Up Form */}
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-gradient-to-br from-slate-50 to-green-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-gray-600">Join the adventure community</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            <div className="hidden lg:block text-center mb-8">
              ...
              <p className="text-gray-600">
                Start sharing gear with your adventure network
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 px-4 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02]"
              >
                Create Account
              </button>
            </form>
